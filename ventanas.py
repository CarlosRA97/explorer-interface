...
button2 = Button(ventana, text="2", command=onoff)
button2.grid(column=1, row=3, padx=(5,5), pady=(5,5))

button3 = Button(ventana, text="3", command=onoff)
button3.grid(column=1, row=4, padx=(5,5), pady=(5,5))

button4 = Button(ventana, text="4", command=onoff)
...
button17 = Button(ventana, text="17", command=onoff)
button17.grid(column=1, row=7, padx=(5,5), pady=(5,5))

button27 = Button(ventana, text="27", command=onoff)
button27.grid(column=1, row=8, padx=(5,5), pady=(5,5))

button22 = Button(ventana, text="22", command=onoff)
...
button10 = Button(ventana, text="10", command=onoff)
button10.grid(column=1, row=11, padx=(5,5), pady=(5,5))

button9 = Button(ventana, text="9", command=onoff)
button9.grid(column=1, row=12, padx=(5,5), pady=(5,5))

button11 = Button(ventana, text="11", command=onoff)
...
button14 = Button(ventana, text="14", command=onoff)
button14.grid(column=2, row=5, padx=(5,5), pady=(5,5))

button15 = Button(ventana, text="15", command=onoff)
button15.grid(column=2, row=6, padx=(5,5), pady=(5,5))

button18 = Button(ventana, text="18", command=onoff)
...
button23 = Button(ventana, text="23", command=onoff)
button23.grid(column=2, row=9, padx=(5,5), pady=(5,5))

button24 = Button(ventana, text="24", command=onoff)
...
button25 = Button(ventana, text="25", command=onoff)
button25.grid(column=2, row=12, padx=(5,5), pady=(5,5))

button8 = Button(ventana, text="8", command=onoff)
button8.grid(column=2, row=13, padx=(5,5), pady=(5,5))

button7 = Button(ventana, text="7", command=onoff)
