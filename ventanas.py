...
button2 = Button(ventana, text="2|SDA", command = onoff(2))
button2.grid(column=1, row=3, padx=(5,5), pady=(5,5))


button3 = Button(ventana, text="3|SCL", command = onoff(3))
button3.grid(column=1, row=4, padx=(5,5), pady=(5,5))

button4 = Button(ventana, text="4", command = onoff(4))
...
button17 = Button(ventana, text="17", command = onoff(17))
button17.grid(column=1, row=7, padx=(5,5), pady=(5,5))

button27 = Button(ventana, text="27", command = onoff(27))
button27.grid(column=1, row=8, padx=(5,5), pady=(5,5))

button22 = Button(ventana, text="22", command = onoff(22))
...
button10 = Button(ventana, text="10|MOSI", command = onoff(10))
button10.grid(column=1, row=11, padx=(5,5), pady=(5,5))

button9 = Button(ventana, text="9|MISO", command = onoff(9))
button9.grid(column=1, row=12, padx=(5,5), pady=(5,5))

button11 = Button(ventana, text="11|SCLK", command = onoff(11))
...
button14 = Button(ventana, text="14|TXD", command = onoff(14))
button14.grid(column=2, row=5, padx=(5,5), pady=(5,5))

button15 = Button(ventana, text="15|RXD", command = onoff(15))
button15.grid(column=2, row=6, padx=(5,5), pady=(5,5))

button18 = Button(ventana, text="18", command = onoff(18))
...
button23 = Button(ventana, text="23", command = onoff(23))
button23.grid(column=2, row=9, padx=(5,5), pady=(5,5))

button24 = Button(ventana, text="24", command = onoff(24))
...
button25 = Button(ventana, text="25", command = onoff(25))
button25.grid(column=2, row=12, padx=(5,5), pady=(5,5))

button8 = Button(ventana, text="8|CE0", command = onoff(8))
button8.grid(column=2, row=13, padx=(5,5), pady=(5,5))

button7 = Button(ventana, text="7|CE1", command = onoff(7))
